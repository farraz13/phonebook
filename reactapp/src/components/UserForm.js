            ...
            <form onSubmit={this.handleSubmit} className="card-body">
                <div className="row mb-3">
                    ...
                    <div className="col-sm-10">
                        <input type={this.props.nameType || "name"} className="form-control form-control-sm" id="name" name="name" placeholder="" onChange={this.handleInputChange} value={this.state.name} />
                    </div>
                </div>
                <div className="row mb-3">
